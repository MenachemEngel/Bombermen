...
//this class hold the data for simple guard
class SimpleGuard :
	public Guard
{
public:
	//c-tor that use his father c-tor
	SimpleGuard(sf::Vector2f pos, sf::Vector2f size, sf::Vector2f startPos , sf::Color color = sf::Color::White)
		: Guard(pos, size, startPos , SIMPLE_GUARD,color)
	{
		randDirection();
